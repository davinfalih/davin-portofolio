                ...
                {visibleCerts.map((cert, idx) => (
                  ...
                  >
                    <div className="relative overflow-hidden">
                      ...
                      <div className="absolute inset-0 bg-gradient-to-t from-[#202124]/70 via-[#202124]/20 to-transparent opacity-0 transition-opacity duration-500 group-hover:opacity-100" />
                      <div className="absolute inset-0 flex items-center justify-center opacity-0 transition-all duration-500 group-hover:opacity-100">
                        <span className="inline-flex items-center gap-2 rounded-full bg-white px-6 py-3 font-semibold text-[#202124] shadow-lg transition-all duration-300 hover:scale-105">
                    ...
                    <div className="p-6">
                      <div className="mb-2 flex items-center justify-between">
                        <span className="text-xs font-semibold uppercase tracking-wide text-[#4285F4]">
                          {cert.category}
                        </span>
                        <span className="text-xs text-[#5f6368] dark:text-slate-400">{cert.year}</span>
                      </div>
                      <h3 className="mb-1 text-xl font-bold text-[#202124] dark:text-white">
                        {cert.title}
                      </h3>
                      <p className="text-sm leading-relaxed text-[#5f6368] dark:text-slate-400">
